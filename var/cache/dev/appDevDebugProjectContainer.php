...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'tacosinlyon', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'path' => NULL, 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EntityManager59f6eb8090ef1_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager59f6eb8090ef1_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once (__DIR__.'/jms_diextra/doctrine/EntityManager_59f6eb8090ef1.php');

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Keosu\\DataModel\\ArticleModelBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Keosu\\CoreBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Keosu\\UserBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Keosu\\DataModel\\LocationModelBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\Keosu\\DataModel\\PictureModelBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\Keosu\\Gadget\\PictureGadgetBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\Keosu\\DataModel\\EventModelBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\Keosu\\Gadget\\CommentGadgetBundle\\Entity'), 8 => ($this->targetDirs[3].'\\src\\Keosu\\Gadget\\PushNotificationBundle\\Entity'), 9 => ($this->targetDirs[3].'\\src\\Keosu\\DataModel\\SearchModelBundle\\Entity'), 10 => ($this->targetDirs[3].'\\src\\Keosu\\DataModel\\MenuModelBundle\\Entity')));
        ...
        $c->addDriver($b, 'Keosu\\Gadget\\PictureGadgetBundle\\Entity');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager59f6eb8090ef1_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7cb74126b228798426c0f00171df7c15f844b1e9f296a8106d6842605aa88a70');
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Keosu\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Keosu\\Gadget\\CalendarGadgetBundle/Resources/views'), 'KeosuGadgetCalendarGadget');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('m0Zjhl1DRiFTduYOvNQo');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'en',
            'secret' => 'm0Zjhl1DRiFTduYOvNQo',
            'installer' => false,
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'm0Zjhl1DRiFTduYOvNQo',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => (__DIR__.'/jms_diextra/doctrine/EntityManager_59f6eb8090ef1.php'),
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager59f6eb8090ef1_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
